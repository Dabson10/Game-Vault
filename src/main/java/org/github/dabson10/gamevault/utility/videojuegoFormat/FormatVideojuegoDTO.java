...
public class FormatVideojuegoDTO {
    ...
    /**
     * Esta función sirve para formatear los datos de una lista de videojuegos y
     * cambiar la plataforma de esta.
     * La unica diferencia es que este regresa una lista con
     * {@code VideojuegoCompletoDTO}.
     ...
     * @return : Regresará una lista con los videojuegos formateados del tipo:
     *         {@code VideojuegoCompletoDTO}
     */
    ...
    /**
     * Esta función sirve para formatear datos de un objeto del tipo
     * {@code Videojuego} a un DTO llamado
     * {@code VideojuegoCompletoDTO}, esta función es utilizada en
     * {@code VideojuegoService}
     * 
     * @param video : Este objeto contendrá los datos fundamentales del videojuego.
     * @return : Regresará un objeto tipo {@code VideojuegoCompletoDTO} con los
     *         datos formateados.
     */
